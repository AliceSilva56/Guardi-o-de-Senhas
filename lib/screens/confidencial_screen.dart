...
class _ConfidencialScreenState extends State<ConfidencialScreen> {
  ...
  void loadPasswords() {
    passwords = PasswordService.searchPasswords('', includeConfidential: true);
    setState(() {});
  }
  ...
  Future<void> addPasswordDialog({PasswordModel? editing}) async {
    ...
    final categoryController = TextEditingController(text: editing?.category ?? 'Pessoal');
      ...
      builder: (_) => StatefulBuilder(builder: (context, innerSetState) {
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              children: [
                // Mantém exatamente igual ao seu código original
                TextField(
            ...
            ElevatedButton(
              ...
              onPressed: () async {
                ...
                final model = PasswordModel(
                  ...
                  category: categoryController.text.isEmpty ? 'Pessoal' : categoryController.text,
      ...
      child: ShaderMask(
        ...
        child: Text(
          ...
          style: const TextStyle(
            ...
            color: Colors.white, // necessário para o shader
            shadows: [
              Shadow(
                blurRadius: 8,
